...
$kodeinacbg = $_POST['kodeinacbg'];
$biayainacbgs = json_encode($_POST['kodeinacbg'], JSON_NUMERIC_CHECK);
$nosep = $_POST['nosep'];
$nosjp = $_POST['nosjp'];
$notes = $_POST['notes'];
...
$ch = curl_init('https://dummy.inhealth.co.id/pelkesws2/api/SimpanBiayaINACBGS');
